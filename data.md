...
**Pack contents:** 10 research briefs · multi-newspaper narratives in [`data.json`](data.json) · 26 downloaded archival images · 2 Library of Congress references left source-only (host returned 403). Partition has one rights-cleared still; other events have three. No unverified newspaper pads, no distressing video stills.
...
Image rights live in the library section below (and later in `ASSET_MANIFEST.md` / `assets/images/` when those land).
...
| --- | --- | --- | --- | --- |
| 01 | `01-apollo-aldrin-near-eagle.jpg` | Apollo 11 | NARA unrestricted | Aldrin near *Eagle*, 20 Jul 1969 — post-EVA, not touchdown |
| 02 | `02-apollo-aldrin-full-frame.jpg` | Apollo 11 | PD US (NASA) | Suit / regolith / scale ref; cite NASA |
| 03 | `03-apollo-lm-surface.jpg` | Apollo 11 | NASA media rules | LM surface; no logo/endorsement; not pre-EVA |
| 04 | `04-berlin-potsdamer-platz-opening.jpeg` | Berlin Wall | NARA unrestricted | Potsdamer Platz opening, 14 Nov 1989 — not Bornholmer on the 9th |
| 05 | `05-berlin-people-walking.jpg` | Berlin Wall | CC BY-SA 2.0 | Berlin 1989; credit Thiémard; date uncertain |
| 06 | `06-berlin-checkpoint-charlie.jpg` | Berlin Wall | CC BY-SA 3.0 DE | Checkpoint Charlie, night of 10 Nov 1989; Bundesarchiv |
| 07 | `07-dday-into-the-jaws.jpg` | D-Day | PD (USCG) | Omaha wade-ashore, 6 Jun 1944; credit Sargent; content note |
| 08 | `08-dday-eisenhower-paratroopers.jpg` | D-Day | PD (US Army) | Eisenhower + 101st, Greenham Common, 5 Jun 1944 |
| 09 | `09-dday-approaching-omaha.jpg` | D-Day | PD (US Navy) | LCVP approaching Omaha — do not re-caption as another beach |
| 10 | `10-march-leadership-procession.jpg` | March on Washington | PD US (USIA) | Leaders to Lincoln Memorial, 28 Aug 1963; NARA 542010 |
...
| 12 | `12-march-reflecting-pool-crowd.jpg` | March on Washington | PD US (USIA) | Reflecting Pool view, 28 Aug 1963; NARA 542045 |
| 13 | `13-partition-gandhi-suhrawardy.jpg` | Partition | PD (IN/PK/BD; US claim on page) | Calcutta fast, 15 Aug 1947 — not Delhi/Lahore; recheck at release |
| 14 | `14-armistice-nyc-celebration.jpg` | Armistice | PD US | NYC celebration, 11 Nov 1918 — city context only |
| 15 | `15-armistice-train.jpg` | Armistice | PD | Compiègne railcar exterior — no invented private talks |
| 16 | `16-armistice-london-crowd.jpg` | Armistice | PD US / PDM; IWM non-commercial note | Buckingham Palace crowd; rights check before commercial use |
| 17 | `17-sf-devastation.gif` | San Francisco | PD (USGS) | Lawrence kite aerial ~May 1906 — later damage, not relief camp |
| 18 | `18-sf-city-hall-ruin.jpg` | San Francisco | NARA unrestricted | City Hall ruin; earthquake vs fire damage differ |
| 19 | `19-sf-golden-gate-relief-camp.jpg` | San Francisco | NARA unrestricted | Golden Gate Park relief camp, 1906 |
| 20 | `20-triangle-fire-exterior.jpg` | Triangle Fire | PD US | Fire exterior, pub. 26 Mar 1911 — evidence, not drama backdrop |
| 21 | `21-triangle-mourning-demonstration.jpg` | Triangle Fire | NARA unrestricted | Mourning/protest demo, 5 Apr 1911 |
| 22 | *source-only* | Triangle Fire | LOC Bain / Commons PDM | Pier morgue crowd; LOC 403 — retrieve only after content note check |
| 23 | `23-bandung-economic-plenary.jpg` | Bandung | PD-IDGov | Economic plenary, Merdeka Building, 20 Apr 1955 |
| 24 | `24-bandung-soekarno-opening.jpg` | Bandung | PD-IDGov | Soekarno opens conference, 18 Apr 1955 — no AI speaking avatar |
| 25 | `25-bandung-savoy-homann-dinner.jpg` | Bandung | PD-IDGov | Savoy Homann dinner, 19 Apr 1955 — no invented private talk |
| 26 | `26-windrush-vessel-profile.jpg` | Windrush | PD (RN) | *Empire Windrush* profile ~1945–54 — not Tilbury arrival |
| 27 | `27-windrush-passenger-list-header.jpg` | Windrush | CC BY-SA 4.0 | Passenger-list header, Jun 1948; attribute + share alike |
| 28 | `28-windrush-monte-rosa.jpg` | Windrush | CC BY-SA 4.0 | *Monte Rosa*, Copenhagen May 1945 — never caption as Tilbury 1948 |
...
Event-level citations and image checks live in the numbered research files when those are added.
